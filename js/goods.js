...
var createCard = function() {
  ...
  card.querySelector(".card__price").innerHTML =
  ...
  sugar === 1
    ? (card.querySelector(".card__characteristic").innerHTML = "<p>Без сахара</p>")
...
var createCardOrder = function() {
  ...
  var cardName = (cardOrder.querySelector(".card-order__title").textContent =
    nameAssort[randomInteger(0, nameAssort.length - 1)]);
